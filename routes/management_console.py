...
from controllers.ManagementConsole import index , searchGuards, createGuard, renderCreateGuardForm, updateGuard, deleteGuard
...
management_console.route('/delete-guard', methods=['GET','POST'])(deleteGuard)